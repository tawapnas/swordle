    ...
    <div className="animate-pop flex w-full max-w-md flex-col items-center gap-6 text-center">
      ...
      >
        ...
        <h2 className="text-2xl font-black">
          {heading ?? (solved ? "Solved it!" : "Not this time")}
        </h2>
        <p className="text-sm font-medium opacity-90">Swordle #{dayNumber}</p>
      </div>

      <div className="grid w-full grid-cols-3 gap-3">
        <Stat icon={<Clock size={18} aria-hidden />} label="Time" value={formatTime(timeMs)} />
        <Stat
      ...
      <p className="text-sm text-ink-soft">Come back tomorrow for a new puzzle.</p>
